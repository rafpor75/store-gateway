package it.infocert.gateway.repository;

import it.infocert.gateway.StoreApp;
import it.infocert.gateway.config.Constants;
import it.infocert.gateway.config.audit.AuditEventConverter;
import it.infocert.gateway.domain.PersistentAuditEvent;
...
import static it.infocert.gateway.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
